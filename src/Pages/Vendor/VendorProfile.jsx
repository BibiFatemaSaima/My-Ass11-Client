      ...
      Promise.all([
        ...
        .then(([tickets, pending, accepted, revenue]) => {
          setStats({
            ...
            acceptedBookings: accepted.data.acceptedBookings,
    ...
    <div className="max-w-6xl mx-auto p-6">
      ...
      <div className="card bg-base-100 shadow-xl border mb-8">
        <div className="card-body items-center text-center">
          ...
          <h2 className="text-3xl font-bold mt-4">Vendor Profile</h2>
          ...
          <div className="mt-5 space-y-2">
            ...
            <p>
              <span className="font-bold">Role:</span> Vendor
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="card bg-success text-white shadow-xl">
          <div className="card-body text-center">
            ...
            <p className="text-4xl font-bold">{stats.acceptedBookings}</p>
          </div>
        </div>
